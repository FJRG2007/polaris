...
| Backgrounds in a call                        | ✅     | -    | -    | Blur, blurred heavily, or a picture of your own behind you. The model is staged by the build and fetched the first time somebody turns one on; the picture never leaves the browser it was chosen in. See `camera-filter` and `camera-background`.                                                                                                                                                                 |
