...
packages/vault-crypto/src/totp.ts       the six digits beside a login, pinned against RFC 6238's own vectors
apps/extension/                         Polaris' own browser extension, another client of the surface below
