...
// ---- AI provider settings/config/streaming: canonical types live in @polaris/genoffice-ai ----
...
import type { FaceVerticalMetrics } from '@polaris/font-metrics'
...
// ---- agent protocol: canonical types live in @polaris/genoffice-agent ----
