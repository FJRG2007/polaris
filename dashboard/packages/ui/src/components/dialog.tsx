    ...
    <RadixDialog.Portal>
        ...
        <RadixDialog.Content
            ...
            className={cn(
                ...
                "fixed left-1/2 top-1/2 z-50 max-h-[85vh] w-full max-w-lg -translate-x-1/2 -translate-y-1/2 overflow-y-auto overscroll-contain rounded-xl border border-border-strong bg-elevated p-5 shadow-modal data-[state=open]:animate-in data-[state=open]:fade-in-0 data-[state=open]:zoom-in-[0.98]",
                className
            )}
            {...props}
        >
