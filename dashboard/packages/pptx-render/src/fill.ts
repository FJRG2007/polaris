 ...
 */
import type { Fill, Stroke, ShadowEffect } from '@polaris/pptx'
...
export function resolveGlow(
  glow: import('@polaris/pptx').GlowEffect | undefined,
  vp: Viewport,
...
export function resolveReflection(
  reflection: import('@polaris/pptx').ReflectionEffect | undefined,
  vp: Viewport,
