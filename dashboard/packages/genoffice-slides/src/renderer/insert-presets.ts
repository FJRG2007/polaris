 ...
 */
import { SHAPE_GALLERY_GROUPS } from '@polaris/genoffice-ui'
import { t, type StringKey } from './i18n/locale'
import type { SmartArtLayout } from "@polaris/pptx"
...
// WordArt presets are shared across apps — see @polaris/genoffice-ui wordart-presets.ts.
