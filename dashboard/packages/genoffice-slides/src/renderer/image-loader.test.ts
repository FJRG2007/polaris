...
describe("collecting a deck image urls", () => {
            ...
            slideOf(imageFill("data:image/png;base64,bg"), [
                {
                    ...
                    box: {},
                    sourceId: "s1",
                    dataUrl: "data:image/png;base64,pic"
                } as RenderNode
            ])
        ]);
    ...
    it("finds a shape fill and its fillOverlay", () => {
        ...
        expect(urls).toEqual(
            new Set(["data:image/png;base64,fill", "data:image/png;base64,overlay"])
        );
    });
    ...
    it("finds a chart background fill and its plot-area fill", () => {
            ...
            slideOf({ kind: "none" }, [
                {
                    ...
                    plotRect: {
                        ...
                        w: 1,
                        h: 1,
                        fill: imageFill("data:image/png;base64,plot")
                    },
                    gridLines: [],
                    axisLines: [],
                    labels: [],
        ...
        expect(urls).toEqual(
            new Set(["data:image/png;base64,chartbg", "data:image/png;base64,plot"])
        );
    });
    ...
    it("finds a table background fill and every cell fill", () => {
                    ...
                    cells: [
                        {
                            ...
                            row: 0,
                            col: 0,
                            fill: imageFill("data:image/png;base64,cell0")
                        },
        ...
        expect(urls).toEqual(
            new Set(["data:image/png;base64,tablebg", "data:image/png;base64,cell0"])
        );
    });
