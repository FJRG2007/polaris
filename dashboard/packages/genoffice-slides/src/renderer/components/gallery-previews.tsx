 ...
 * is shared across apps via @polaris/genoffice-ui (re-exported here for existing
 * imports); SmartArt thumbs reuse the engine's layout math so preview and
 * insert result always match.
 */
import { shapePreviewPath } from '@polaris/genoffice-ui'
import {
  layoutShapes,
  type SmartArtLayout,
} from "@polaris/pptx/smartart-layout"

export { ShapePreview, shapePreviewBox, shapePreviewPath } from '@polaris/genoffice-ui'
