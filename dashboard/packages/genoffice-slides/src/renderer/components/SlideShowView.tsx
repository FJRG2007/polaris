...
import type { RenderNode, RenderSlide, ShapeRenderNode } from '@polaris/pptx-render'
...
function ShowMediaLayer({
  ...
  const nodes = slide.nodes.filter(
    (n): n is import('@polaris/pptx-render').PictureRenderNode =>
      n.type === 'picture' && !!(n as import('@polaris/pptx-render').PictureRenderNode).media,
  )
