...
import type { SlideComment, SectionInfo } from '@polaris/pptx'
import type {
  AiSettings,
  AiStreamChunk,
  AiStreamRequest,
  GenSparkAccountStatus,
} from '@polaris/genoffice-ai'

export type { SlideComment, SectionInfo } from '@polaris/pptx'

// Canonical definitions of AI-related types live in @polaris/genoffice-ai / @polaris/genoffice-agent (shared with docs)
export type {
  AiProviderConfig,
  AiProviderId,
  AiProviderMeta,
...
export { AI_PROVIDERS } from '@polaris/genoffice-ai'
export type { AgentToolCall, AgentToolDef } from '@polaris/genoffice-agent'
