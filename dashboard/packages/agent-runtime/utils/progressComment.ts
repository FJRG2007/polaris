 ...
 * the GitHub comments Polaris uses to surface a run's status.
 *
...
/**
 * Discriminated target for `createProgressPlaceholderComment`. The two variants map to the two
...
/**
 * Create the initial "Working on it..." progress comment.
 *
 ...
 */
export async function createProgressPlaceholderComment(
  ctx: ApiCtx,
