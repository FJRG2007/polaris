...
//   1. `captureBaselineModels` - called BEFORE Polaris-stored credentials
...
// Polaris-stored auth to this run - logged once for operator visibility
 ...
 * Polaris-stored credentials are merged in. Call once early in `main.ts`. */
...
/** Authorized set captured after Polaris-stored auth is applied. Throws if
