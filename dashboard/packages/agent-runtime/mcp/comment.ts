...
import { buildPolarisFooter, stripExistingFooter } from "../utils/buildPolarisFooter.ts";
...
// re-export for backward compat with anything importing the progress-placeholder helpers from mcp/comment
export {
...
export async function reportProgress(
  ...
  if (existingComment) {
    ...
    try {
      ...
      const created = await createProgressPlaceholderComment(
        apiCtx,
 ...
 * Used by main.ts for stranded-comment cleanup (orphaned "Working on it" or
