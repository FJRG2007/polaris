...
const SECURITY_CHANGES: Readonly<Record<string, SecurityChange>> = {
    ...
    "account.email.added": { title: "An email address was added to your account", href: "/account/details" },
    "account.email.removed": { title: "An email address was removed from your account", href: "/account/details" },
    "account.email.primary-changed": { title: "Your main email address changed", href: "/account/details" },
