 ...
 * person each staring at nothing.
 */
    ...
    const meetingId =
        ...
        (
            await prisma.meeting.create({
                data: { channelId, hostId: actor.id },
                select: { id: true }
            })
        ).id;
