...
import { footageTarget } from "@/lib/footage-storage";
import { driverForTarget, placeFile, safeName, LOCAL_TARGET } from "@/lib/storage-target";
...
export {
    ...
    footageTarget,
    setFootageTarget,
    type FootageSettings
} from "@/lib/footage-storage";
