 ...
 *
 * A list of sessions is read by scanning, not by reading: the logo is what says
 * "that one is my phone" before any of the words are taken in. They are official
 * marks, inline like every other mark in this UI so they cost no request, and
...
export function BraveMark(props: SVGProps<SVGSVGElement>) {
    return (
        <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" {...mark(props)}>
            <path
                fill="#FB542B"
...
export function FirefoxMark(props: SVGProps<SVGSVGElement>) {
    return (
        <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" {...mark(props)}>
            <path
                fill="#FF7139"
...
export function OperaMark(props: SVGProps<SVGSVGElement>) {
    return (
        <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" {...mark(props)}>
            <path
                fill="#FF1B2D"
...
export function VivaldiMark(props: SVGProps<SVGSVGElement>) {
    return (
        <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" {...mark(props)}>
            <path
                fill="#EF3939"
...
/** Safari's official mark, left in its brand blue. The compass detail is lost at
 *  16px, which is true of the real icon at that size too - it is recognised by
 *  its colour and its circle, which both survive. */
export function SafariMark(props: SVGProps<SVGSVGElement>) {
    return (
        <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" {...mark(props)}>
            <path
                fill="#006CFF"
...
/** Windows' official mark - the four panes, in the brand blue they are published
 *  in. It reads on a light and on a dark surface alike, so unlike Apple's and
 *  Tux's it keeps its colour. Its four squares are the whole logo, which is the
 *  rare case of a mark that loses nothing at 16px. */
...
/** Apple's mark, which stands for macOS and for iOS. Left as `currentColor`:
 *  the official mark is black, and black on a dark surface is no mark at all. */
...
/** Tux, in `currentColor` rather than the official pale yellow, which all but
 *  disappears against a light surface at this size. */
export function LinuxMark(props: SVGProps<SVGSVGElement>) {
    return (
        <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" {...mark(props)}>
            <path
                fill="currentColor"
...
export function AndroidMark(props: SVGProps<SVGSVGElement>) {
    return (
        <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" {...mark(props)}>
            <path
                fill="#34A853"
...
/** The mark for a browser, by the name `describeClient` gave it. A browser with
 *  no redistributable mark falls back to the neutral globe rather than to a
 *  lookalike. */
export function BrowserMark({ browser, className }: { browser: string; className?: string }) {
    const size = cn("size-4", className);
    if (browser === "Chrome") return <ChromeMark className={size} />;
    if (browser === "Brave") return <BraveMark className={size} />;
    if (browser === "Firefox") return <FirefoxMark className={size} />;
    if (browser === "Safari") return <SafariMark className={size} />;
    if (browser === "Edge") return <EdgeMark className={size} />;
    if (browser === "Opera") return <OperaMark className={size} />;
    if (browser === "Vivaldi") return <VivaldiMark className={size} />;
    return <Globe aria-hidden className={cn(size, "text-muted-foreground")} />;
}

/** The same, for an operating system. Apple stands for both of its. */
export function SystemMark({ os, className }: { os: string; className?: string }) {
    const size = cn("size-4", className);
    if (os === "Windows") return <WindowsMark className={size} />;
    if (os === "macOS" || os === "iOS") return <AppleMark className={size} />;
