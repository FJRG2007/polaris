/**
 * Official brand marks for the messaging channels, as inline single-path SVGs
 * (source: Simple Icons, the platforms' own marks) drawn with `currentColor` so
 * each is tinted with its brand color by the caller. Kept here so the connect
 * picker and anywhere else can render a real logo rather than a generic glyph.
 */

import type { SVGProps } from "react";
import { mark } from "@/components/brand-icons";

/** Discord's mark moved to the shared set once a Discord account became something
 *  a person links as well as a channel a bot posts to. Re-exported under the name
 *  this file's other logos use, so nothing that draws a channel has to know. */
export { DiscordMark as DiscordLogo } from "@/components/brand-icons";
