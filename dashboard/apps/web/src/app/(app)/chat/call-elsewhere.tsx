...
import { callElsewhereAction } from "./meeting-actions";
                    ...
                    <Button
                        ...
                        onClick={() =>
                            enter(
                                ...
                                // Never the camera. Moving a call is not a
                                // decision to be seen, and the switch is in the
                                // room.
                                false
                            )
                        }
                    >
                        {/* The conversation as well as the call: arriving in the
                            room somebody just moved a call into, rather than on
                            whatever screen they happened to be looking at. */}
                        <Link href={`/chat/c/${found.channelId}`}>
