...
import { recognizerFor } from "./recognizer";
import { parseDetection } from "./cameras";
import { zonesByCamera } from "./camera-zones";
import type { Zone } from "@polaris/core";
import { createHash, timingSafeEqual } from "node:crypto";
import { assertServer, findService } from "./side-service";
import { relayEndpoint, relayServerFor, streamName } from "./relay";
import { detectorReaches, type Detector, type ObjectClass } from "./detection";
import { host } from "@polaris/app-host";

const { appBaseUrl } = host.domainService;
