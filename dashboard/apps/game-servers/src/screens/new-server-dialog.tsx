...
import { expectedArkMemoryMb } from "../lib/ark/config";
...
import { formatMemory } from "../lib/minecraft/blueprints";
import type { ServerTemplateView } from "../lib/game-templates";
import {
            ...
            game === "hytale"
                ...
                : game === "ark"
                  ...
                  : {
                        ...
                        softwareSource: edition === "java" ? shape.source || undefined : undefined,
