...
| 4 | Cross-compile (aarch64-musl via `cross`/Docker) + systemd unit | done - agent built in CI for aarch64 + x86_64 musl and published in release `unifi-unas-v0.1.0` (static ELF verified) |
